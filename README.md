...
⚠️ **This package is not further maintaned nor developed as the personal use case that led to its development is no longer existent. This repo will be archived, however it won't be deleted.**
